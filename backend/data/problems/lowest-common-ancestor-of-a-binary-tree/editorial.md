# Lowest Common Ancestor — Editorial

## Overview
Find the lowest shared ancestor node of two specified target nodes.

## Why Learn This?
High frequency medium-level interview question for testing algorithm design and tree proficiency.

## Recognition Clues
Look for array/string traversal where tree properties or sliding boundaries reduce time complexity.

## Prerequisites
Tree fundamentals, recursion, or hashing

## Concepts Used
Tree pattern optimization, search space reduction
...
### Approach
Apply tree specific optimal traversal or data structure mapping to satisfy target time/space constraints.
