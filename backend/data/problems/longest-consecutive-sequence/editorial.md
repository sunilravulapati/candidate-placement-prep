# Longest Consecutive Sequence — Editorial

## Overview
Find the length of the longest consecutive elements sequence in O(n).

## Why Learn This?
High frequency medium-level interview question for testing algorithm design and hashing proficiency.

## Recognition Clues
Look for array/string traversal where hashing properties or sliding boundaries reduce time complexity.

## Prerequisites
Hashing fundamentals, recursion, or hashing

## Concepts Used
Hashing pattern optimization, search space reduction
...
### Approach
Apply hashing specific optimal traversal or data structure mapping to satisfy target time/space constraints.
...
## Pseudocode
```text
# Medium Hashing optimal pattern
