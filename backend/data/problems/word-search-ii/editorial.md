# Word Search II — Editorial

## Overview
Find all words from a dictionary that exist in a board (Trie + DFS).
...
## Prerequisites
Mastery of trie, dynamic programming, advanced graph/tree traversal

## Concepts Used
Complex Trie algorithms, state compression, optimization
...
### Approach
Leverage advanced trie algorithms, multi-dimensional DP, or monotonic data structures to achieve optimal asymptotic bounds.
