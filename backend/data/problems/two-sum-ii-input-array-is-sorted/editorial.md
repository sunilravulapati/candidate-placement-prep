# Two Sum II — Editorial

## Overview
Two-pointer variant of Two Sum on a sorted array.

## Why Learn This?
Essential entry-level two pointers pattern used in technical screening interviews.

## Recognition Clues
Look for array/string traversal where two pointers properties or sliding boundaries reduce time complexity.

## Prerequisites
Basic two pointers syntax and fundamentals

## Concepts Used
Two Pointers traversal, conditionals, pointers
...
### Approach
Traverse the input using standard two pointers techniques, updating state variables or hash maps as required.
...
## Pseudocode
```text
# Standard Two Pointers solution pattern
initialize results
for item in input:
  process item
return result
