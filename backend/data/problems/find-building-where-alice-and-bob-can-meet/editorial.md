# Find Building Where Alice and Bob Can Meet — Editorial

## Overview
Find the earliest building where two moving indices can meet.
...
## Prerequisites
Mastery of binary search, dynamic programming, advanced graph/tree traversal

## Concepts Used
Complex Binary Search algorithms, state compression, optimization
...
### Approach
Leverage advanced binary search algorithms, multi-dimensional DP, or monotonic data structures to achieve optimal asymptotic bounds.
...
## Pseudocode
```text
# Hard Binary Search optimal approach
