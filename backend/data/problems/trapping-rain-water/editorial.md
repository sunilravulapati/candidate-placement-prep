...
## Overview
Compute how much water can be trapped after raining over an elevation map.
...
## Prerequisites
Mastery of two pointers, dynamic programming, advanced graph/tree traversal

## Concepts Used
Complex Two Pointers algorithms, state compression, optimization
...
### Approach
Leverage advanced two pointers algorithms, multi-dimensional DP, or monotonic data structures to achieve optimal asymptotic bounds.
...
## Pseudocode
```text
# Hard Two Pointers optimal approach
