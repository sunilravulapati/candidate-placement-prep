...
## Overview
Check whether a binary tree is a structurally valid BST.

## Why Learn This?
High frequency medium-level interview question for testing algorithm design and bst proficiency.

## Recognition Clues
Look for array/string traversal where bst properties or sliding boundaries reduce time complexity.

## Prerequisites
BST fundamentals, recursion, or hashing

## Concepts Used
BST pattern optimization, search space reduction
...
### Approach
Apply bst specific optimal traversal or data structure mapping to satisfy target time/space constraints.

## Step-by-Step Algorithm
1. Initialize data structures (BST).
2. Traverse input while updating current boundary or accumulator.
3. Return result once target state is reached.

## Pseudocode
```text
# Medium BST optimal pattern
...
## Revision Notes
Key BST question frequently asked in FAANG/Top Tech interview loops.
