# Word Break II — Editorial

## Overview
Advanced problem on word break ii.

## Why Learn This?
Teaches crucial optimization skills for backtracking.

## Recognition Clues
Look for array/string traversal where backtracking properties or sliding boundaries reduce time complexity.

## Prerequisites
Mastery of backtracking

## Concepts Used
Backtracking, State Optimization
...
### Approach
Use optimal algorithmic technique.
...
## Revision Notes
Added advanced question: Word Break II
