          ...
          <div className="space-y-6">
            ...
            {problem.constraints.length > 0 && (
              <div className="space-y-3 pt-4 border-t border-slate-800">
                <h3 className="text-white font-semibold text-lg">Constraints</h3>
                <ul className="space-y-2">
                  {problem.constraints.map((constraint) => (
                    <li
                      key={constraint}
                      className="bg-slate-800/30 rounded-lg border border-slate-700/50 px-3 py-2 font-mono text-sm text-slate-300"
                    >
                      {constraint}
                    </li>
                  ))}
